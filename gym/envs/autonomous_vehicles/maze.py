...
class Shape:
    ...
    """
    def __init__(self, space, r=30, pos=(50,height - 100), angle=0.5, color='orange',
...
class ACarMaze(gym.Env):
    ...
    def _configure(self, args=None):
        ...
        # Create the car.
        self.car = Shape(self.space, r=30, pos=starting_pos_car, color='green', static=False,
                         collision_type=CT_CAR)
        self.target = Shape(self.space, r=10, pos=starting_pos_target, color='orange', collision_type=CT_TARGET)
    ...
    def create_maze(self):
        walls = [
            ...
            pymunk.Segment(self.space.static_body, (200, 350), (width, 350), 5),
            pymunk.Segment(self.space.static_body, (0, 525), (width - 200, 525), 5),
        ]
        for s in walls:
            s.friction = 1.
            s.group = 1
